...
const JobWidget = (job: Database["public"]["Tables"]["jobs"]["Row"]) => {
	return (
		<div className="w-full md:w-5/12 md:min-w-80 pl-6 py-1 border-l-2 border-black">
			...
			<div className="text-md text-gray-600 mb-1">{job.company}</div>
			<div className="text-md">{job.description_short}</div>
		</div>
	);
};
	...
	return (
		<div>
			<div className="w-full flex flex-col items-center bg-prussian-blue text-white py-10">
				...
				<div
					className={
						" text-[20px] md:text-[30px] font-[100] pt-8 md:pt-12 pb-8 w-7/12 text-center leading-tight"
					}
				>
			...
			<div className="px-8 md:px-20">
				<div className="py-20">
					...
					<div className="my-4">
						We host open positions from a variety of organizations
						with aligned missions.
					</div>
					<Link
						href="/create-job-post"
						target="_blank"
						className="py-2 px-3 border border-black rounded-3xl w-fit"
					>
						Post a Job
					</Link>
					{/*</Link>*/}
